          ...
          <div class="prescription_headers">
            ...
            <?php if(!empty(session('patient_id'))): ?>
                    ...
                    <?php $patient = get_name_by_id(session('patient_id'),'patientses');?>
    								<i style="font-weight: bold;">Name :</i> <i> <?= isset($patient['name'])?$patient['name']:'';?></i> 
    							</div>
    							<div class="right_top">
    								<ul>
    									<li><i>Age:</i> <?= html_escape($patient['age']);?> Years</li>
    									<li><i>Weight:</i> <?= html_escape($patient['weight']);?> Kg</li>
    									<li><i>Date:</i><?= my_date_show(session('prescription_date'))?></li>
    								</ul>
    							</div>
    						</div>
    					</div>	

        ...
        <?php if (isset($page_title) && $page_title == "Edit"): ?>
          ...
          <div class="box-tools pull-right">
            <?php if (isset($page_title) && $page_title == "Edit"): ?>
              ...
              <?php else: ?>
                <a href="<?php echo base_url('clinic-admin/patients') ?>" class="text-right btn btn-light-secondary btn-sm mt-10"><i class="fa fa-bars"></i> <?php echo trans('all-patients') ?></a>
              <?php endif; ?>
            </div>
          </div>

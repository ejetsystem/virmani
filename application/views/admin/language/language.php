      ...
      <div class="row">
        ...
        <div class="col-md-4 add_area">
            ...
            <div class="box input_area">
                ...
                <div class="box-body">
                    <form id="cat-form" method="post" class="validate-form" action="<?php echo base_url('superadmin/settings/set_language')?>" role="form">
                        ...
                        <button type="submit" class="btn btn-primary pull-left m-t-10"><i class="fa fa-check"></i> <?php echo trans('update') ?></button>
                    </form>
                </div>
            </div>
            <?php endif; ?>
                    ...
                    <form id="cat-form" method="post" class="validate-form" action="<?php echo base_url('admin/language/add')?>" role="form">
                        ...
                        <div class="row mt-20 mb-10">
                            ...
                            <div class="col-sm-8 text-left m-t-5">
                              <div class="radio radio-info radio-inline" dir="<?php echo text_dir(); ?>">
                                  <input type="radio" id="inlineRadio2" value="ltr" name="text_direction" <?php if($language[0]['text_direction'] == 'ltr'){echo "checked";} ?>>
                                  <label for="inlineRadio2"> LTR (Left to Right)</label>
                              </div>

                              <div class="radio radio-info radio-inline" dir="<?php echo text_dir(); ?>">
                                  <input type="radio" id="inlineRadio1" value="rtl" name="text_direction" <?php if($language[0]['text_direction'] == 'rtl'){echo "checked";} ?>>
                        ...
                        <?php if (isset($page_title) && $page_title == "Edit"): ?>
                          <button type="submit" class="btn btn-primary pull-left m-t-10"><i class="fa fa-check"></i> <?php echo trans('save-changes') ?></button>
                        <?php else: ?>
                          <button type="submit" class="btn btn-primary pull-left m-t-10"><i class="fa fa-check"></i> <?php echo trans('save') ?></button>
                        <?php endif; ?>
                                  ...
                                  <?php $i=1; foreach ($languages as $lang): ?>
                                    <tr id="row_<?php echo html_escape($lang->id); ?>">
                                        ...
                                        <td class="text-center" width="50%">
                                            <a href="<?php echo base_url('admin/language/values/user/'.html_escape($lang->slug)) ?>" class="badge badge-secondary-soft mt-5 brd-20"><i class="fa fa-pencil"></i> <?php echo trans('edit-user-values') ?></a>

                                            <a href="<?php echo base_url('admin/language/values/admin/'.html_escape($lang->slug)) ?>" class="badge badge-secondary-soft mt-5 brd-20"><i class="fa fa-pencil"></i> <?php echo trans('edit-admin-values') ?></a>

                                            <a href="<?php echo base_url('admin/language/values/front/'.html_escape($lang->slug)) ?>" class="badge badge-secondary-soft mt-5 brd-20"><i class="fa fa-pencil"></i> <?php echo trans('edit-frontend-values') ?></a>
                                        </td>

                                        <td class="actions" width="40%">
                                          
                                          <a href="<?php echo base_url('superadmin/language/edit/'.html_escape($lang->id));?>" class="on-default edit-row" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> &nbsp; 

                                          <a data-val="Language" data-id="<?php echo html_escape($lang->id); ?>" href="<?php echo base_url('superadmin/language/delete/'.html_escape($lang->id));?>" class="on-default remove-row delete_item" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a> &nbsp;

                            ...
                            foreach ($drugs as $drug):
                                ...
                                <tr id="row_<?php echo html_escape($drug->id); ?>">
                                    ...
                                    <td class="actions" width="22%">
                                        ...
                                        <a href="javascript:void(0);" onclick="viewDetail('<?php echo html_escape($drug->id); ?>')" class="on-default edit-row" data-placement="top" title="<?php echo trans('view') ?>"><i class="fa fa-eye"></i></a>

<div class="content-wrapper">
  ...
  <section class="content container">
    ...
    <!-- user dashboard area -->
    <?php if (isset($page_title) && $page_title == 'Doctor Home'): ?>
      <div class="row">
          <!-- Column -->
          <div class="col-lg-3 col-md-4" data-aos="fade-down" data-aos-duration="200">
              <a href="<?php echo base_url('doctor/appointment/list/'.date('Y-m-d')) ?>">
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-down" data-aos-duration="240">
              <a href="<?php echo base_url('doctor/appointment/all_list') ?>">
                <div class="card shadow-lg">
                    <div class="card-body bg-default">
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center mt-10">
                                ...
                                <h4 class="m-0 text-dark"><?php echo count($appointments); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-down" data-aos-duration="280">
              <a href="<?php echo base_url('doctor/staff') ?>">
                  <div class="card shadow-lg">
                      <div class="card-body bg-default">
                          <div class="d-flex flex-row">
      ...
      <div class="row p-0 mt-20">
        ...
        <?php if (is_doctor() && check_feature_access('online-consultation') == TRUE): ?>
        <div class="col-md-7">
                  ...
                  <tbody>
                    <?php $i=1; foreach ($appointments as $amp): ?>
                      <tr id="row_<?php echo html_escape($amp->id); ?>">
                          ...
                          <td><?php echo html_escape($amp->patient_name); ?></td>
                          <td><?php echo html_escape($amp->patient_phone); ?></td>
                          <td>
                            <label class="font-weight-bold"><?php echo my_date_show($amp->date); ?></label>
                          </td>
                          
                          <td class="actions" width="15%">
                            <a data-val="experience" data-id="<?php echo html_escape($amp->id); ?>" href="<?php echo base_url('doctor/appointment/delete/'.html_escape($amp->id));?>" class="on-default remove-row delete_item" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a>
                          </td>
                      </tr>
                    <?php $i++; endforeach; ?>
                  </tbody>
    ...
    <div class="row">
        <!-- Column -->
        <div class="col-lg-3 col-md-4" data-aos="fade-down" data-aos-duration="200">
            <a href="<?php echo base_url('doctor/users') ?>">
                <div class="card shadow-lg">
                    <div class="card-body bg-default">
                        <div class="d-flex flex-row">
            ...
            <div class="box-body p-0">
              ...
              <?php endforeach ?>
                <div class="text-center bt-1 border-light">
                  <a class="btn btn-light-default btn-block" href="<?php echo base_url('doctor/users') ?>"><?php echo trans('see-all-users') ?> <i class="fa fa-long-arrow-right"></i></a>
                </div>
              </div>
            </div>
        </div>

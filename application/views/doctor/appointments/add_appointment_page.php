  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input type="hidden" name="doctors_id" id="doctors" value="<?php echo $this->session->userdata('id'); ?>" class="form-control">
        <input type="text" disabled name="doctors_name" id="doctors_name" value="<?php echo $this->session->userdata('name'); ?>" class="form-control">
      </div>
    </div>
    <div class="col-md-6">

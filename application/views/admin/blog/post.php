    ...
    <div class="box add_area <?php if(isset($page_title) && $page_title == "Edit"){echo "d-block";}else{echo "hide";} ?>">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <?php if (isset($page_title) && $page_title == "Edit"): ?>
            <a href="<?php echo base_url('superadmin/blog') ?>" class="pull-right btn btn-primary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a>
          <?php else: ?>
      ...
      <div class="box-body">
        <form id="cat-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('superadmin/blog/add')?>" role="form" novalidate>
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="slug" value="<?php echo html_escape($blog[0]['slug']); ?>">
          </div>
                  ...
                  <?php $i=1; foreach ($posts as $post): ?>
                    <tr id="row_<?php echo html_escape($post->id); ?>">
                        ...
                        <td class="actions" width="12%">
                          <a href="<?php echo base_url('superadmin/blog/edit/'.html_escape($post->id));?>" class="on-default edit-row" data-placement="top" title="<?php echo trans('edit') ?>"><i class="fa fa-pencil"></i></a> &nbsp; 

                          <a data-val="Category" data-id="<?php echo html_escape($post->id); ?>" href="<?php echo base_url('superadmin/blog/delete/'.html_escape($post->id));?>" class="on-default remove-row delete_item" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a> &nbsp;

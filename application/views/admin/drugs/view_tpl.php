					...
					<div class="col-lg-12 col-md-12 col-sm-12 paddlr">
						<div class="row">
							<div class="col-lg-2 col-md-2 col-sm-4">
								<?php  
								$img = (!empty($drug['medicine_image'])) ? $drug['medicine_image'] : 'no_medicine_image.png';
								?>
								<img id="medicine_image" src="<?php echo base_url("uploads/medicine/".$img); ?>" style="width:120px;height: 120px;border-radius: 5px;box-shadow: 0 0.5rem 1.5rem rgba(0,0,0,0.175);"/>
							</div>    

...
<div class="content-wrapper">
  ...
  <section class="content container">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
            <a href="<?php echo base_url('doctor/live_consults') ?>" class="pull-right btn btn-light-secondary mb-15"><i class="icon-calendar"></i> <?php echo trans('consultations') ?>  </a>
          </div>

      <div class="col-md-12">

          <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('doctor/live_consults/evisit_settings')?>" role="form" novalidate>

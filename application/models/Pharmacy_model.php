...
class Pharmacy_model extends CI_Model {
    ...
    public function getBranddetail($brand_id) {
        $query = $this->db->where("id", $brand_id)->get('medicine_brand');
        return $query->row_array();
    }

    public function getPharmacydetail($medicine_name,$medicine_brand_id,$medicine_category_id) {
        $query = $this->db->where(array("medicine_name"=>$medicine_category_id,"medicine_brand_id"=>$medicine_brand_id,"medicine_category_id"=>$medicine_name))->get('pharmacy'); 

...
class Staff_model extends CI_Model {
 ...
 public function adddeler($data) {
     ...
     public function vaccinationInsert($data) {

            $this->db->insert('vaccinations', $data);
            return $this->db->insert_id();
       
    }


    public function materialInsert($data)
    {
         $this->db->insert('dealer_material', $data);
            return $this->db->insert_id();
    }

     public function insurencewInsert($data) {

            $this->db->insert('insurance_list', $data);
            return $this->db->insert_id();
       
    }

     public function BankinfoInsert($data) {
    ...
    public function dealerInsert($data)
    {
        $this->db->insert('dealers', $data);
            return $this->db->insert_id();
    }
    ...
    public function delerremove($id) {
 $this->db->where('id', $id);
        $this->db->delete('dealers');

    }

    public function vaccineremove($id) {
        $this->db->where('id', $id);
        $this->db->delete('vaccinations');
    }

     public function bankeremove($id) {
        $this->db->where('id', $id);
        $this->db->delete('bank_information');
    }

    public function removevaccination($id) {
        $this->db->where('staff_id', $id);
        $this->db->delete('vaccinations');
    }
    public function removebankinfo($id) {
        $this->db->where('staff_id', $id);
        $this->db->delete('bank_information');
    }

    public function removebankinfodealer($id) {
      ...
      public function removeinsurance($id) {
        $this->db->where('staff_id', $id);
        $this->db->delete('insurance_list');
    }

     public function removemeterial($id) {
        $this->db->where('staff_id', $id);
        $this->db->delete('dealer_material');
    }

    

        public function insurenceremove($id) {
        $this->db->where('id', $id);
        $this->db->delete('insurance_list');
    }

public function meterialremove($id) {
        $this->db->where('id', $id);
        $this->db->delete('dealer_material');
    }
    ...
    function getDealers()
    {
         $query = $this->db->select('*')->get("dealers");
    ...
    function getdealerProfile($id)
    {
        $data = array('id' => $id);
        $query = $this->db->select('*')->where($data)->get("dealers");
        return $query->row_array();
    }

      ...
      <div class="col-md-12">
        ...
        <div class="box add_area <?php if(isset($page_title) && $page_title == "Edit"){echo "d-block";}else{echo "hide";} ?>">
          ...
          <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
              <?php if (isset($page_title) && $page_title == "Edit"): ?>
                <a href="<?php echo base_url('doctor/live_consults') ?>" class="pull-right btn btn-light-primary mt-15 btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a>
              <?php else: ?>
          ...
          <div class="box-body">
            <form id="cat-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('doctor/live_consults/edit/'.$consult[0]['id'])?>" role="form" novalidate>
        ...
        <?php if (isset($page_title) && $page_title != "Edit"): ?>
          <div class="box list_area">
            <div class="box-header with-border">
              <?php if (isset($page_title) && $page_title == "Edit"): ?>
                <h3 class="box-title"><?php echo trans('edit') ?> <a href="<?php echo base_url('doctor/live_consults') ?>" class="pull-right btn btn-primary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a></h3>
              <?php else: ?>
                <h3 class="box-title"><img src="<?php echo base_url('assets/images/video-call.png') ?>"> &nbsp; <?php echo trans('consultations') ?> </h3>
              <?php endif; ?>

              <div class="box-tools pull-right">
               <a href="<?php echo base_url('doctor/live_consults/settings') ?>" class="pull-right btn btn-primary mt-15"><i class="icon-settings"></i> <?php echo trans('settings') ?></a>
              </div>
            </div>
                              ...
                              <td class="action" width="20%">
                                ...
                                <?php if($amp->type == 'online'): ?>
                                  <?php if($amp->is_start == 0 && $amp->type == 'online'): ?>
                                    <a target="_blank" href="<?php echo base_url('doctor/live/zoom/doctor/'.html_escape($amp->id));?>" class="btn btn-primary btn-sm start_meeting" data-toggle="tooltip" data-placement="top" title="<?php echo trans('zoom-start-info') ?>"><i class="fa fa-play-circle"></i> <?php echo trans('start') ?></a>
                                  <?php else: ?>
                                    <a href="<?php echo base_url('doctor/live/cancel_meeting/'.html_escape($amp->id));?>" class="btn btn-light-danger btn-sm"><i class="fa fa-times"></i> <?php echo trans('cancel-meeting') ?></a>
                                  <?php endif; ?>
                                <?php endif; ?>
                                ...
                                <?php if($amp->status == 0): ?>
                                  ...
                                  <a target="_blank" href="<?php echo base_url('doctor/prescription?patient_id='.$amp->patient_id.'&appointment='.$amp->id);?>" class="btn btn-light-success btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo trans('create-prescription-for') ?> <?php echo html_escape($amp->name); ?>"><i class="fa fa-plus-circle fs-18"></i></a>
                                <?php endif ?>

                                <a href="<?php echo base_url('doctor/live_consults/edit/'.$amp->id);?>" class="btn btn-light-danger btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo trans('edit') ?>"><i class="icon-note"></i></a>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('doctor/payment/offline_payment/'.$amp->id)?>" role="form" novalidate>

          ...
          <form id="cat-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/doctor/add')?>" role="form" novalidate>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <input type="text" class="form-control" required name="gender" value="<?php echo html_escape($staff[0]['gender']); ?>" >
            </div>
              <div class="form-group">
              <label><?php echo ('Date of Birth') ?> <span class="text-danger">*</span></label>
              <input type="text" class="form-control" required name="dob" value="<?php echo html_escape($staff[0]['dob']); ?>" >
            </div>

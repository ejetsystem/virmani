                    ...
                    <?php $i=1; foreach ($appointments as $amp): ?>
                      <tr id="row_<?php echo html_escape($amp->id); ?>">
                          ...
                          <td class="actions" width="15%">
                            <a data-val="experience" data-id="<?php echo html_escape($amp->id); ?>" href="<?php echo base_url('superadmin/appointment/delete/'.html_escape($amp->id));?>" class="on-default remove-row delete_item" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a>
                          </td>
                      </tr>
                    <?php $i++; endforeach; ?>
                  </tbody>
            ...
            <div class="box-body p-0">
              ...
              <?php endforeach ?>
                <div class="text-center bt-1 border-light">
                  <a class="btn btn-light-default btn-block" href="<?php echo base_url('superadmin/users') ?>"><?php echo trans('see-all-users') ?> <i class="fa fa-long-arrow-right"></i></a>
                </div>
              </div>
            </div>
        </div>

    ...
    <div class="container mt-200 mb-20">
        <div class="text-center m-auto col-md-6">
            <div class="pay_status p-20">
              ...
              <a class="btn btn-success btn-lg" href="<?php echo base_url('clinic-admin/subscription/upgrade/'.$slug.'/'.$billing_type.'/1') ?>"><i class="ficon flaticon-check"></i> Yes Continue </a>
            </div>
        </div>
    </div>
  </section>

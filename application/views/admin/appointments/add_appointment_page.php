...
<div class="row">
  <div class="col-md-6">
    <div class="form-group">
      <label> <?php echo ucfirst('cause') ?> </label>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input type="text" readonly name="name" value="<?php echo $patient_details[0]['name'] ?>" class="form-control">
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        <label>Patient Number</label>
        <input type="number" readonly name="number" value="<?php echo $patient_details[0]['mobile'] ?>" class="form-control">
      </div>
    </div>
  </div>
<?php }?>

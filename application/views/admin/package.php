          ...
          <?php $i=1; foreach ($packages as $package): ?>
            <div class="col-lg-4 col-sm-12 col-xs-12 text-center">
               ...
               <div class="pricing-table purple text-center shadow-lg">
                  ...
                  <!-- Button -->
                  <a class="btn btn-light-secondary btn-lg btn-block mt-30" href="<?php echo base_url('superadmin/package/edit/'.$package->id) ?>"><i class="fa fa-pencil"></i> <?php echo trans('edit-plan') ?></a>
               </div>
            </div>
          <?php endforeach ?>

        ...
        <form method="post" action="<?php echo base_url('admin/payment/user_update') ?>" role="form" class="form-horizontal pr-20">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title d-block">Razorpay  <span class="pull-right"><input type="checkbox" name="razorpay_payment" value="1" <?php if(user()->razorpay_payment == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="primary" data-width="80"></span></h3>
                </div>
            ...
            <div class="col-sm-6">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title d-block">Paystack  <span class="pull-right"><input type="checkbox" name="paystack_payment" value="1" <?php if(user()->paystack_payment == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="primary" data-width="80"></span></h3>
                </div>
